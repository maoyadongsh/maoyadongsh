...
<h3>Agent systems</h3>
<p>Connect tool calls to authorization, provenance and effect evidence so Agent actions can be constrained and verified.</p>
<p><strong>Runtime integration · Authorization · Effect verification</strong></p>
<p><a href="https://github.com/maoyadongsh/siq-agent-security">Public work: SIQ Agent Security →</a></p>
</td>
<td width="50%" valign="top">
<p><sub>02 / ENTERPRISE PLATFORMS</sub></p>
<h3>Enterprise platforms</h3>
<p>Connect identity, human approvals, model governance and unified workbenches into cooperating enterprise services.</p>
<p><strong>Identity &amp; access · Workflows · Service governance</strong></p>
<p><sub>Private development · Capability overview</sub></p>
</td>
</tr>
<tr>
<td width="50%" valign="top">
...
<p>Connect documents and structured evidence to retrieval and multi-agent analysis, keeping research grounded in source material.</p>
<p><strong>Document understanding · Evidence lineage · Research workflows</strong></p>
<p><sub>Private development · Capability overview</sub></p>
</td>
<td width="50%" valign="top">
<p><sub>04 / BUSINESS APPLICATIONS</sub></p>
<h3>Business applications</h3>
<p>Bring domain models, approvals and analysis into workflows for investment research and management, corporate governance and people operations.</p>
<p><strong>Domain modeling · Decision support · Product interaction</strong></p>
<p><sub>Private development · Capability overview</sub></p>
</td>
</tr>
</table>
